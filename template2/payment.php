					...
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						...
						<li class="nav-item dropdown active mr-lg-2 mb-lg-0 mb-2">
							...
							<div class="dropdown-menu">
								...
								<a class="dropdown-item active" href="payment.php">Payment Page</a>
							</div>
						</li>
						<li class="nav-item">
				...
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						...
						<ul>
							...
							<li class="mb-3">
								<i class="fas fa-mobile"></i> +229 64745149 </li>
							<li class="mb-3">
								<i class="fas fa-phone"></i> +222 11 4444 </li>
							<li class="mb-3">
								<i class="fas fa-envelope-open"></i>
								<a href="mailto:example@mail.com"> abyssiniea@gmail.com</a>
							</li>
							<li>
								<i class="fas fa-envelope-open"></i>
