...
if(isset($_POST['submit'])){
		...
		$item_name = $_POST['add'];
		$add = $_POST['item_name'];
		$disc_amount = $_POST['discount_amount'];
...
<body>
			...
			<div class="row main-top-w3l py-2">
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						...
						<li class="text-center border-right text-white">
							<a href="#" data-toggle="modal" data-tarPOST="#exampleModal" class="text-white">
						...
						<li class="text-center text-white">
							<a href="#" data-toggle="modal" data-tarPOST="#exampleModal2" class="text-white">
				...
				<div class="modal-body">
					<form action="#" method="POST">
						...
						<p class="text-center dont-do mt-3">Don't have an account?
							<a href="#" data-toggle="modal" data-tarPOST="#exampleModal2">
								Register Now</a>
						</p>
					</form>
				</div>
	...
	<div class="navbar-inner">
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<div class="agileits-navi_search">
					<form action="#" method="POST">
						<select id="agileinfo-nav_search" name="agileinfo_search" class="border" required="">
							...
							<option value="Fruits &amp; VePOSTables">Tv &amp; Video</option>
				...
				<button class="navbar-toggler" type="button" data-toggle="collapse" data-tarPOST="#navbarSupportedContent" aria-controls="navbarSupportedContent"
					...
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						...
						<li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
							...
							<div class="dropdown-menu">
								...
								<a class="dropdown-item" href="payement.php">Payment Page</a>
							</div>
						</li>
						<li class="nav-item">
	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
		...
		<ol class="carousel-indicators">
			...
			<li data-tarPOST="#carouselExampleIndicators" data-slide-to="3"></li>
		</ol>
					...
					<div class="wrapper">
											...
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="" method="POST">
													<fieldset>
														...
														<input type="submit" name="submit1" value="Add to cart" class="button btn" />
							...
							<div class="row">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.php">Artis Speaker</a>
											</h4>
											<div class="info-product-price my-2">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.php">Philips Speakers</a>
											</h4>
											<div class="info-product-price my-2">
						...
						<div class="product-sec1 product-sec2 px-sm-5 px-3">
							<div class="row">
								...
								<p class="w3l-nut-middle">POST Extra 10% Off</p>
											...
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="" method="POST">
													<fieldset>
														...
														<input type="hidden" id="amount" name="amount" value="199.00" />
														<input type="hidden" name="discount_amount" value="1.00" />
														<input type="hidden" name="currency_code" value="USD" />
														<input type="hidden" name="return" value=" " />
														<input type="hidden" name="cancel_return" value=" " />
			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids">
						...
						<ul>
							<li class="mb-3">
								<a href="product.php">Mobiles </a>
							</li>
							<li class="mb-3">
								<a href="product.php">Computers</a>
							</li>
							<li class="mb-3">
								<a href="product.php">TV, Audio</a>
							</li>
							<li class="mb-3">
								<a href="product2.php">Smartphones</a>
							</li>
							<li class="mb-3">
								<a href="product.php">Washing Machines</a>
							</li>
							<li>
								<a href="product2.php">Refrigerators</a>
							</li>
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						<h3 class="text-white font-weight-bold mb-3">POST in Touch</h3>
						<ul>
							<li class="mb-3">
			...
			<div class="container">
				...
				<div class="sub-some mt-4">
					...
					<ul>
						...
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Data Cards</a>
						</li>
					</ul>
				</div>
				<div class="sub-some mt-4">
					...
					<ul>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">TVs & DTH</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Home Theatre Systems</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Hidden Cameras & CCTVs</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Refrigerators</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Washing Machines</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2"> Air Conditioners</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Cameras</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Speakers</a>
						</li>
					</ul>
				</div>
				<div class="sub-some mt-4">
					...
					<ul>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Headphones</a>
						</li>
						<li class="m-sm-1">
						...
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">External Hard Disks</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2"> Mouse</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Smart Watches & Fitness Bands</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">MicroSD Cards</a>
						</li>
					</ul>
				</div>
				<div class="sub-some mt-4">
					...
					<ul>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Trimmers</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Hair Dryers</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Emergency Lights</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Water Purifiers </a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Electric Kettles</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Hair Straighteners</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Induction Cooktops</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Sewing Machines</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2"> Geysers</a>
						</li>
					</ul>
				</div>
				<div class="sub-some mt-4">
					...
					<ul>
						...
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Couple Watches</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Gas Stoves</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2"> Air Coolers</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Air Purifiers</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Headphones</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2"> Headsets</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Pressure Cookers</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Sandwich Makers</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Air Friers</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Irons</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">LED TV</a>
						</li>
						<li class="m-sm-1">
							<a href="product2.php" class="border-right pr-2">Sandwich Makers</a>
						</li>
	...
	<script>
        window.onload =  function(){
       	document.POSTElementById("amount").onSubmit = valeurs;
       }
       function valeurs(){
       	var data =  document.POSTElementById("amount").value;
       	document.POSTElementById("amount").setCustomValidity('fdgf');
       }



		window.onload = function () {
			document.POSTElementById("password1").onchange = validatePassword;
			document.POSTElementById("password2").onchange = validatePassword;
		}

		function validatePassword() {
			var pass2 = document.POSTElementById("password2").value;
			var pass1 = document.POSTElementById("password1").value;
			if (pass1 != pass2)
				document.POSTElementById("password2").setCustomValidity("Passwords Don't Match");
			else
				document.POSTElementById("password2").setCustomValidity('');
