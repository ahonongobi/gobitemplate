	...
	<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div id="print_div_1" class="modal-body">
					<form action="#" method="post">
						<div class="form-group">
						...
						<div  class="col-2 top_nav_right text-center mt-sm-0 mt-2">
							<div class="wthreecartaits wthreecartaits2 cart cart box_1">
								<form   action="" method="post" class="last">
									...
									<button  data-print-area='#oui' class="btn w3view-cart save-image" type="submit" name="submit" value="">
					...
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						...
						<li class="nav-item dropdown active mr-lg-2 mb-lg-0 mb-2">
							...
							<div class="dropdown-menu">
								...
								<div class="dropdown-divider"></div>
								<a class="dropdown-item active" href="checkout.php">Checkout Page</a>
	...
	<div class="privacy py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			...
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
				<span>C</span>heckout   <button class='save-image' data-print-area='.modal fade'>Capture Image1</button>
			</h3>
			<!-- //tittle heading -->
	...
	<div class="copy-right py-3">
		<div class="container">
			<p class="text-center text-white">© 2018 Electro Store. All rights reserved | Design by
				<a href="http://w3layouts.com"> abyssiniea@gmail....</a>
			</p>
		</div>
	</div>
	<!-- //copyright -->
